...
def zhongyao(test_video_path_muzhi_1, test_video_path_shizhi_1, test_video_path_zhongzhi_1, test_video_path_huanzhi_1, test_video_path_xiaozhi_1, test_video_path_sizhi, test_video_path_muzhi, socre_FMA, socre_MSS):
    ...
    # ops.model = "mediapipe"
    print("mediapipe模型")
    hand_joint_x, hand_joint_y, idx = mediapipe_video.med_model(ops.model_path, test_video_path, ops.vis,
                                                                clear_path="D:/python_project/handpose_shibie/handpose_x-main/shibie_img_med/")
    hand_joint_x_1, hand_joint_y_1, idx_1 = mediapipe_video.med_model(ops.model_path, test_video_path_sizhi, ops.vis,
                                                                      clear_path="D:/python_project/handpose_shibie/handpose_x-main/shibie_img_med_sizhi/")
    hand_joint_x_2, hand_joint_y_2, idx_2 = mediapipe_video.med_model(ops.model_path, test_video_path_muzhi, ops.vis,
                                                                      clear_path="D:/python_project/handpose_shibie/handpose_x-main/shibie_img_med_muzhi/")
    hand_joint_x_mu, hand_joint_y_mu, idx_mu = mediapipe_video.med_model(ops.model_path, test_video_path_muzhi_1,
                                                                         ops.vis,
                                                                         clear_path="D:/python_project/handpose_shibie/handpose_x-main/shibie_img_med_mu/")
    hand_joint_x_zhong, hand_joint_y_zhong, idx_zhong = mediapipe_video.med_model(ops.model_path,
                                                                                  test_video_path_zhongzhi_1, ops.vis,
                                                                                  clear_path="D:/python_project/handpose_shibie/handpose_x-main/shibie_img_med_zhong/")
    hand_joint_x_huan, hand_joint_y_huan, idx_huan = mediapipe_video.med_model(ops.model_path,
                                                                               test_video_path_huanzhi_1, ops.vis,
                                                                               clear_path="D:/python_project/handpose_shibie/handpose_x-main/shibie_img_med_huan/")
    hand_joint_x_xiao, hand_joint_y_xiao, idx_xiao = mediapipe_video.med_model(ops.model_path,
                                                                               test_video_path_xiaozhi_1, ops.vis,
    ...
    socre_SIE = jisuan_SIE(socre_2_3, socre_3_4, socre_5_6, socre_6_7, socre_7_8, socre_9_10, socre_10_11, socre_11_12,
                           socre_13_14, socre_14_15, socre_15_16,
                           socre_17_18, socre_18_19, socre_19_20)
    ...
    socre_touch = touchs(time_8_red, time_8_blue, time_4_red, time_4_blue, time_12_red, time_12_blue, time_16_red,
                         time_16_blue, time_20_red, time_20_blue)

    ########## 总分数 #########
    zong_socre = socre_SIE * 0.4 + socre_touch * 0.3 + (socre_FMA + socre_MSS) * 0.5
    print("SIE分数: %f" % socre_SIE)
    print("按触分数: %f" % socre_touch)
    print("总分数：%f" % zong_socre)
    print("FMA分数：%f" % socre_FMA)
    print("MSS分数：%f" % socre_MSS)

    test.xieru(score_SIE=socre_SIE, score_touch=socre_touch, zong_score=zong_socre, score_FMA=socre_FMA, score_MSS=socre_MSS)

    print('well done ')

    return zong_socre, socre_touch, socre_SIE
    # sys.exit()  # 终止程序执行，不再执行以下代码
